...
public class UnderstandingNull {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("myOtherObjects =" + myOtherObject);


        System.out.println("myLocalObject"+ myLocalObject);
        //System.out.println("anotherLocalObject" + anotherLocalObject); because it is not initilized it cannot be used


        //null = empty containter
